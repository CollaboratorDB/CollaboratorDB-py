...
Welcome to `collaboratordb` contributor's guide.
...
If you experience bugs or general issues with `collaboratordb`, please have a look
...
You can help improve `collaboratordb` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`collaboratordb` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `collaboratordb`'s files. While this mechanism can
...
```
conda create -n collaboratordb python=3 six virtualenv pytest pytest-cov
conda activate collaboratordb
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/collaboratordb.git
   cd collaboratordb
   ```
...
5. Install [pre-commit]:
   ...
   `collaboratordb` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/collaboratordb
[issue tracker]: https://github.com/<USERNAME>/collaboratordb/issues
